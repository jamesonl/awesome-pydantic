...
- [Clipstick](https://github.com/sander76/clipstick) 🌟(43) - Clipstick creates your cli using Pydantic models. Define a Pydantic model as you would normally do, pass it to `clipstick` and you get a cli including subcommands, nice docstrings and validations based on `typing` and `pydantic` validators.
...
- [django-pydantic-field](https://github.com/surenkov/django-pydantic-field) 🌟(219) - Django JSONField with Pydantic models as a Schema. DRF supported.
